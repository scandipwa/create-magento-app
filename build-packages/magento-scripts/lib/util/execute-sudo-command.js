...
/**
 * @type {(command: string, options: Omit<import('../util/exec-async-command').ExecAsyncSpawnOptions<false>, 'callback' | 'pipeInput'>) => import('listr2').ListrTask<import('../../../typings/context').ListrContext>}
 */
